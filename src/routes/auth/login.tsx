...
import { Sparkles, Github, Mail, Lock, Eye, EyeOff } from "lucide-react";
        ...
        >
          <div className="rounded-2xl p-8 ring-1 ring-white/10 glass-card">
            <div className="mb-8 text-center">
              ...
              <p className="mt-1 text-sm text-zinc-500">Sign in to continue to PromptOS</p>
            </div>
            ...
            <p className="mt-6 text-center text-xs text-zinc-500">
              ...
              <Link to="/auth/register" className="font-medium text-zinc-200 hover:text-zinc-100">
                Sign up
              </Link>
            </p>
          </div>
